...
for (let index = 1; index <= numberCards; index++) {
    space.innerHTML = space.innerHTML + '<div class="card" id="'+index.toString()+'"><p><i class="fa-solid fa-user-secret"></i></p></div>\n'
}
// Menu buttons
...
function close(card){
    ...
    console.log("not")
    setTimeout(() => {
        card.innerHTML = '<p><i class="fa-solid fa-user-secret"></i></p>'
        console.log("hi")
    }, 500);
    setTimeout(() => {
